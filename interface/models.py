...
class Submission(models.Model):
    ...
    stdout = models.CharField(max_length=4096, default='none')
    stderr = models.CharField(max_length=4096, default='none')
    ...
    def verify_jwt(self, message):
        ...
        decoded_message = jwt.decode(str(message),
                                     settings.SECRET_KEY,
                                     algorithms=['HS256'])

        return decoded_message == self.id
